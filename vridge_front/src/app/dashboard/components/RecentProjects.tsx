...
const RecentProject: React.FC<RecentProjectProps> = ({ 
  ...
  const statusLabels = {
    planning: { text: '', color: 'bg-blue-100 text-blue-700' },
    production: { text: '', color: 'bg-yellow-100 text-yellow-700' },
    feedback: { text: '', color: 'bg-purple-100 text-purple-700' },
    completed: { text: '', color: 'bg-green-100 text-green-700' },
  };
